...
class BehaviourNode:
    ...
    def __init__(self, name, honesty, emotionality, extroversion, agreeableness, conscientiousness, openness, 
                     happiness=0, sadness=0, anger=0, fear=0, disgust=0, surprise=0, love=0, jealousy=0, guilt=0, pride=0, stress=0, anxiety=0, fatigue=0, tags=[], start_time=time(0, 0), end_time=time(23, 59), active_days=[0, 1, 2, 3, 4, 5, 6]):
            self.name = name
